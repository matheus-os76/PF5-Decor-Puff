...
public class TelaCadastrarProduto extends javax.swing.JFrame {
     ...
     */
    public TelaCadastrarProduto(Database db, Funcionario f) {
        initComponents();
    ...
    private void initComponents() {
        ...
        cbCategoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione...", "BRINQUEDOS", "FANTASIAS", "DECORACOES" }));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
       ...
       String nome = txtNomeItem.getText().trim();
        ...
        try {
           ...
           try {
               DB.addItem(new Item(0, nome, Categoria.valueOf(categoria), descricao, quantidade, precoVendaFinal, precoAluguelFinal, Status_Item.ESTOQUE));
           } catch (Exception ex) {
               System.getLogger(TelaCadastrarProduto.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
           }
            ...
            TelaCatalogo tlc = new TelaCatalogo(DB, funcionario);
